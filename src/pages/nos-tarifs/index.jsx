        ...
        <>
                ...
                <div className="">
                    <div className="grid md:grid-cols-2 items-center gap-20">
                        ...
                        <div className="space-y-4 md:pl-10 md:pr-12 md:px-0 px-6">
                            ...
                            <p className="text-[16px] text-[var(--gray)] leading-8">Chez AgenceAlpha, vous profiterez de tarifs compétifis tout en conservant des Leads de qualité ! Que ce soit en gestion de campagnes ou en synergie avec vos équipes, nous adaptons pour chacun de nos clients les leviers d’acquisition et notre méthode de travail, vous permettant d’obtenir des leads ultra qualifié à prix compétitif.</p>
            ...
            <section className="py-20 md:px-0 px-6 bg-[#f9f9f9]">
                <div className="container mx-auto relative z-10 text-center max-w-6xl">
                    <h4 className="text-[16px] text-[var(--light-blue)] uppercase font-semibold mb-6">Nos tarifs en toute transparence</h4>
                    <h2 className="md:text-[40px] text-[28px] text-[var(--dark-blue)] font-bold mb-2">Les meilleurs Leads <br />au meilleur prix</h2>
                </div>
            </section>
            <Footer />
        </>
