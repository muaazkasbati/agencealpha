...
//                         <li><a href="/" className="text-[var(--light-blue)] hover:text-[var(--light-blue)] text-[14px] font-semibold">Accueil</a></li>
//                         <li><a href="#" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Notre Agence</a></li>
//                         <li><a href="#" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Nos Références</a></li>
//                         <li><a href="#" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Nos Leads</a></li>
//                         <li><a href="#" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Nos Tarifs</a></li>
//                         <li><a href="#" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Contact</a></li>
//                         <li><a href="#" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Blog</a></li>
    ...
    return (
        <header className={`fixed top-0 w-full z-20 ${isFixed ? 'py-3 bg-white/60 backdrop-blur-lg' : 'py-5 bg-white'} shadow-sm shadow-black/5 transition-all duration-300`}>
            <nav className="container mx-auto flex justify-between items-center max-w-8xl px-4 md:px-10">
                <a href='/'>
                    <img src="https://lotuscale.com/images/logotext.svg" alt="Logo"
                        className={`${isFixed ? "w-[100px]" : "w-[140px]"} transition-all duration-300`} />
                </a>

                {/* Desktop Menu */}
                <ul className="hidden lg:flex space-x-3 items-center">
                    <li><a href="/" className="text-[var(--light-blue)] hover:text-[var(--light-blue)] text-[14px] font-semibold">Accueil</a></li>
                    <li><a href="/notre-agence" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Notre Agence</a></li>
                    <li><a href="/nos-references" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Nos Références</a></li>
                    <li><a href="/nos-leads" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Nos Leads</a></li>
                    <li><a href="/nos-tarifs" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Nos Tarifs</a></li>
                    <li><a href="/contact" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Contact</a></li>
                    {/* <li><a href="/blog" className="text-black/60 hover:text-[var(--light-blue)] text-[14px] font-semibold">Blog</a></li> */}
                    <li><a href="tel:0756868686" className="bg-[var(--light-blue)] text-[13px] font-semibold text-white uppercase rounded-[12px] py-1 px-2">07 56 86 86 86</a></li>
                    <li><a href="tel:0493131756" className="bg-[var(--light-blue)] text-[13px] font-semibold text-white uppercase rounded-[12px] py-1 px-2">04 93 13 17 56</a></li>
                </ul>
                ...
                <div className={`lg:hidden fixed top-0 left-0 h-full w-full bg-white transition-transform duration-300 z-20 ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                    <div className="p-6">
                        ...
                        <ul className="flex flex-col space-y-4">
                            <li><a href="/" className="text-[var(--light-blue)] text-[16px] font-semibold">Accueil</a></li>
